...
#### Glass Music Widget 🎵
* Built a visually dynamic, beat-driven desktop equalizer widget using **Python** and **PyQt**.
* Features a custom "future retro" aesthetic and interactive drag-and-drop UI logic.

#### Chant Room 🗣️
* Developed an interactive application designed to facilitate [briefly describe what Chant Room does here, e.g., real-time audio sharing/community chanting].
...
#### 🎮 Currently Building: Untitled 2D Game
* Actively developing a new 2D gaming experience utilizing the **Unity Engine** and C#.
